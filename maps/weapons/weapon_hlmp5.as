/*  
* MP5 without Glauncher or Zoom. but the weapon are Spam-Able by using both attack fires
*/
...
class weapon_hlmp5 : ScriptBasePlayerWeaponEntity
{
	...
	void SecondaryAttack()
	{
		...
		if( self.m_iClip == 0 && m_pPlayer.m_rgAmmo( self.m_iSecondaryAmmoType ) <= 0 )
			// HEV suit - indicate out of ammo condition
			m_pPlayer.SetSuitUpdate( "!HEV_AMO0", false, 0 );
			
		m_pPlayer.pev.punchangle.x = Math.RandomLong( -2, 2 );

		self.m_flNextSecondaryAttack = self.m_flNextSecondaryAttack + 0.1;
